module.exports = {
    ...
    rules: {
        ...
        "function-paren-newline": ["error", "multiline"], // 함수의 인자가 여러줄일 경우, 첫번째 인자는 첫줄에, 나머지는 각각 한줄씩
        ...
        "function-call-argument-newline": ["error", "always"], // 함수 인자에 줖바꿈 금지
        "comma-dangle": ["error", "always"], // 마지막 콤마 강제, git diff 가독성 향상
        "max-len": [2, 200, 4, {"ignoreUrls": true}], // 한줄의 최대 길이
        "operator-linebreak": ["error", "before"],             // 삼항 연산자 ?와 : 줄 앞에
    }
};